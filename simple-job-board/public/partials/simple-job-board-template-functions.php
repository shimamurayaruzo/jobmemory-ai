...
if (!function_exists('sjb_get_the_company_name')) {
    ...
    function sjb_get_the_company_name($post = NULL) {
        ...
        $post = get_post($post);
        if (!$post || $post->post_type !== 'jobpost') {
            return '';
        }
...
if (!function_exists('sjb_get_the_excerpt')) {
    ...
    function sjb_get_the_excerpt() {
        ...
        $show_view_more_btn = 'no';
        if ($excerpt_length > apply_filters('sjb_get_the_excerpt_len', 199)) {
            $excerpt_text .= '...';
            $show_view_more_btn = 'yes';
        }

        $more = '<div class="sjb-apply-now-btn"><p>' . sjb_get_the_apply_now_btn() . '<div class="sjb-view-less-btn" id="sjb_view_less_btn_' . $post->ID . '"><a data-id="' . $post->ID . '" class="sjb_view_less_btn sjb_view_more_btn">' . esc_html__('View less', 'simple-job-board') . '</a></div></p></div>';

        $excerpt = '<div id="sjb_less_content_' . $post->ID . '"><p>' . $excerpt_text;
        if ($show_view_more_btn == 'yes' && $get_view_less_more_btn == 'enable-view-less-more-btn') {
            $excerpt .= '<a data-id="' . $post->ID . '" class="sjb_view_more_btn">' . esc_html__('View more', 'simple-job-board') . '</a>';
        }
        $excerpt .= '</p></div>';
...
if (!function_exists('sjb_http_responses_code')) {
    ...
    function sjb_http_responses_code($code = NULL) {
        ...
        $text = '';
        switch ($code) {
            case 100: $text = __('Continue.', 'simple-job-board');
                break;
            case 101: $text = __('Switching Protocols.', 'simple-job-board');
                break;
            case 203: $text = __('Non-Authoritative Information', 'simple-job-board');
                break;
            case 204: $text = __('No Content', 'simple-job-board');
                break;
            case 205: $text = __('Reset Content', 'simple-job-board');
                break;
            case 206: $text = __('Partial Content', 'simple-job-board');
                break;
            case 300: $text = __('Multiple Choices', 'simple-job-board');
                break;
            case 301: $text = __('Moved Permanently', 'simple-job-board');
                break;
            case 302: $text = __('Moved Temporarily', 'simple-job-board');
                break;
            case 303: $text = __('See Other', 'simple-job-board');
                break;
            case 304: $text = __('Not Modified', 'simple-job-board');
                break;
            case 305: $text = __('Use Proxy', 'simple-job-board');
                break;
            case 400: $text = __('Bad Request. Please try again.', 'simple-job-board');
                break;
            case 401: $text = __('Unauthorized Access. Please try again.', 'simple-job-board');
                break;
            case 402: $text = __('Payment Required', 'simple-job-board');
                break;
            case 403: $text = __('Access Forbidden. Please try again.', 'simple-job-board');
                break;
            case 404: $text = __('Not Found. Please try again.', 'simple-job-board');
                break;
            case 405: $text = __('Method Not Allowed. Please try again.', 'simple-job-board');
                break;
            case 406: $text = __('Not Acceptable. Please try again.', 'simple-job-board');
                break;
            case 407: $text = __('Proxy Authentication Required. Please try again.', 'simple-job-board');
                break;
            case 408: $text = __('Request Time-out. Please try again.', 'simple-job-board');
                break;
            case 409: $text = __('Conflict. Please try again.', 'simple-job-board');
                break;
            case 410: $text = __('Gone', 'simple-job-board');
                break;
            case 411: $text = __('Length Required. Please try again.', 'simple-job-board');
                break;
            case 412: $text = __('Precondition Failed. Please try again.', 'simple-job-board');
                break;
            case 413: $text = __('Request Entity Too Large. Please try again.', 'simple-job-board');
                break;
            case 414: $text = __('Request-URI Too Large. Please try again.', 'simple-job-board');
                break;
            case 415: $text = __('Unsupported Media Type. Please try again.', 'simple-job-board');
                break;
            case 500: $text = __('Internal Server Error. Please try again.', 'simple-job-board');
                break;
            case 501: $text = __('Not Implemented. Please try again.', 'simple-job-board');
                break;
            case 502: $text = __('Bad Gateway. Please try again.', 'simple-job-board');
                break;
            case 503: $text = __('Service Unavailable. Please try again.', 'simple-job-board');
                break;
            case 504: $text = __('Gateway Time-out. Please try again.', 'simple-job-board');
                break;
            case 505: $text = __('HTTP Version not supported. Please try again.', 'simple-job-board');
                break;
            default:
