...
class Simple_Job_Board_Settings_Filters {
    ...
    public function sjb_add_settings_section() {
        ...
        <div data-id="settings-job_filters" class="sjb-admin-settings tab">
            ...
            <form method="post" id="job_filters_form">
                    ...
                    <div class="sjb-content">
                        ...
                        <div class="sjb-form-group">
                            ...
                            $display_job_tags = get_option('display_job_tags') ? get_option('display_job_tags'):"";
                             ?>   
                            <label>
                            <input type="checkbox" name="display_job_tags" value="display_job_tags" id="display_job_tags" <?php echo esc_attr($display_job_tags == 'display_job_tags') ? 'checked' : '' ?>/><?php esc_html_e("Enable Job Tags ", 'simple-job-board'); ?>
                            </label>
                ...
                <input type="hidden" value="1" name="selected_hidden_tag">
                <input type="hidden" value="1" name="admin_notices" />
                <input type="hidden" name="settings_filter_nonce" value="<?php echo wp_create_nonce('jobpost_filter_settings') ?>" >
    ...
    public function sjb_save_settings_section() {
        ...
        if ( NULL == filter_input( INPUT_POST, 'settings_filter_nonce' ) ) {            
            return;
        }
        
        // Verify that the nonce is valid.
        check_admin_referer('jobpost_filter_settings', 'settings_filter_nonce');
