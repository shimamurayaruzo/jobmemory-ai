...
class Simple_Job_Board_Settings_Email_Notifications {
    ...
    public function sjb_add_settings_section() {
        ...
        <div data-id="settings-email_notifications" class="sjb-admin-settings tab">
            <form method="post" id="email_notification_form">
                    ...
                    <div class="sjb-section">
                        ...
                        <div class="sjb-content-email-notify">
                            ...
                            <div class="sjb-form-group">
                                ...
                                <?php
                                $HR = '<input type="email" name="hr_email" value="' . esc_attr($hr_email) . '" size="30">';
                                echo apply_filters('sjb_settings_hr_email', wp_kses($HR, $allowed_tags));
                                ?>
                            </div>
                            ...
                            <div class="sjb-form-group">
                                ...
                                echo apply_filters('sjb_settings_admin_email', wp_kses($ADMIN, $allowed_tags));
                                ?>
                            </div>
                            <div class="sjb-form-group right-align">
                ...
                <input type="hidden" name="settings_email_notifications_nonce" value="<?php echo wp_create_nonce('jobpost_email_notifications_settings'); ?>" >
    ...
    public function sjb_save_settings_section() {
        ...
        if (NULL == filter_input(INPUT_POST, 'settings_email_notifications_nonce')) {
            return;
        }

        // Verify that the nonce is valid.
        check_admin_referer('jobpost_email_notifications_settings', 'settings_email_notifications_nonce');
