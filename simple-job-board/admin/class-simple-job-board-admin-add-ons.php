...
class Simple_Job_Board_Add_Ons {
     ...
     *
     * @since   2.2.3
     * @since   2.9.5   Updated $api_url url for API call.
     */
                                ...
                                if ("Simple Plugin Integration" !== $item->title &&
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 product">
                                        <article>
                                            ...
                                            <?php echo wp_kses( $item->short_description, $allowed_tags ); ?>
                                            <div class="price add-to-cart">
                                                <?php if($item -> type != 'grouped') {?>
            
                                                <span><b><?php echo '$' . esc_attr( $item->price ); ?></b></span>
                                                <?php }?>
                                                <a href="<?php echo esc_url($item->permalink ); ?>" class="button button-primary cart-btn" target="_blank"><?php echo esc_html__('Buy Now', 'simple-job-board'); ?></a>
                                            </div>
                                        </article>
                                    </div>
                                    <?php
