 ...
 * 
 * Override this template by copying it to yourtheme/simple_job_board/v2/job-filters.php
 *
 * @author 	PressTigers
...
<!-- Start Job Filters
================================================== -->
<div class="<?php echo apply_filters('filters_form_class', esc_attr( $class )); ?> sjb-filters-v2">
    <?php
     ...
     */
    ?>
    <form class="filters-form" action="<?php echo apply_filters('sjb_job_filters_form_action', esc_url($action_page_url) ); ?>" method="<?php echo apply_filters('sjb_job_filters_form_method', 'get'); ?>">
        <div class="row">
            <?php
            /**
            ...
            if(!empty($display_job_tags) && $display_job_tags=='display_job_tags' ){
                get_simple_job_board_template('search/tag-filter.php');
            }
            ?>
        </div>
    </form>
